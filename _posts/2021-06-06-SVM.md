...
$$
min \space \frac{1}{2}\|W\|^{2} = min \space \frac{1}{2}W^{T}W \space s.t. \space y_{i}(W.X+b) \geq 1 \space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space(7)
$$
...
![]({{ site.baseurl }}/images/svm_linear_inseparable_3_hyperplanes.png "Fig: 15. Penalities for data points being on wrong side")
