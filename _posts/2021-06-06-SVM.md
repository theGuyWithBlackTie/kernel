...
As we have seen earlier, the best hyperplane is the one with the maximum margin. In Fig. 4, the margin $M_1$ between two <span style="color:red">*red*</span> support vectors is not the biggest margin possible. The biggest margin is margin $M_2$ with different hyperplane as shown in Fig. 5:

![]({{ site.baseurl }}/images/svm_maths_3.png "Fig: 4. Optimal Hyperplane and Support Vectors")
