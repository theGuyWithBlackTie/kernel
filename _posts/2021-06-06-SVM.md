...
{% include alert.html text="Hyperplanes always divides the datasets into two classes only." %}Hyperplanes are **n-1 -dimensional** planes where **n** is total number of features of the dataset. From the above image, data is 2 dimensional and hyperplane divding the space is a 1 dimensional plane.
...
Apart from the **black** coloured hyperplane line, there are other infinite hyperplanes available(to name few: red, blue, yellow) which could differentiate the dataset too. 
