...
Let:
    ...
    * $H_o$ be the hyperplane having equation $W.X + b = -1$
    * $H_1$ be the hyperplane having equation $W.X + b = 1$
    * $x_o$ be a point on hyperplane $H_0$
...
1. <span style="background-color:#323443">has magnitude of $m$</span>
2. it is perpendicular to hyperplane $H_1$
...
<span style="background-color:#323443">
1. $\|\|k\|\| = m
