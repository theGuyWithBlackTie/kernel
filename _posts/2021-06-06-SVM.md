...
Taking the previous example again, below hyperplane has the maximum **margin** possible between a hyperplane and its support vector and hence the best hyperplane to segregate the classess.
![]({{ site.baseurl }}/images/svm_sv_margin.png "Fig: 3. Best Hyperplane with its Support Vector")

{% include alert.html text="The larger the margin the better it is." %}

#### Intuition for Large Margins
Maximizing the margin seems good because data points near the 
