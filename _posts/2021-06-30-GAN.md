...
{% include info.html text="[Kullback-Leibler divergence is not same as Leibler-Kullback divergence!! ;)](!https://www.linkedin.com/posts/aasinghal_machinelearning-statistics-deeplearning-activity-6865717753618214912-jrEH)" %}
...
$$
D_{JS}(p\|q) = \frac{1}{2}D_{KL}(p\|\frac{p+1}{2})+\frac{1}{2}D_{KL}(q\|\frac{p+q}{2})
$$
...
$$
J(P,Q) = \frac{1}{2}(D_{KL}(P \| E)) + D_{KL}(Q \| R)
$$
