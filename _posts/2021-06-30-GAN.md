...
\space\space\space\space\space\space\space\space\space\space\space\space=\mathbb{E}_{x \sim p_{data}}[log\frac{p_{data}(x)}{p_{data}(x)+p_{g}(x)}] + \mathbb{E}_{z \sim p_{g}}[log\frac{p_{g}(x)}{p_{data}(x)+p_{g}(x)}]
$$
