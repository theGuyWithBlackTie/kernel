...
![]({{ site.baseurl }}/images/GAN_.png "Fig: 2. GANs Overview")
...
{% include info.html text="Discriminator takes real images and fake images one after another and calculate their probabilites for being fake or real" %}
