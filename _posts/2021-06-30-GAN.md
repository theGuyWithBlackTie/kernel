...
images: {{ site.baseurl }}/images/GAN_3.png
---
...
The Vanilla GAN (original GAN paper from Ian Goodfellow) code can be found [here](!https://github.com/theGuyWithBlackTie/GAN-PyTorch) in `jupyter notebook` format and could be used to playaround: [Vanilla GAN Code](!https://github.com/theGuyWithBlackTie/GAN-PyTorch)
